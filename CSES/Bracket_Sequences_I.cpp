/**
 * @file Bracket_Sequences_I.cpp
 * @author Sowrav Nath (Sowravnath05102002@gmail.com)
 * @version 0.1
 * @date 2024-09-18
 * @copyright Copyright (c) 2024
 * @problem: CSES - https://cses.fi/problemset/task/2064
 * @approach:
 * @explanation: https://www.geeksforgeeks.org/program-nth-catalan-number/#:~:text=Catalan%20numbers%20occur,2%20chords%20intersect.
...
void solve(){
    fact_invfact();
    int n; cin >> n;
    cout << (n%2 ? 0 : gun(inverse_mod(n/2+1, M), nCr(n, n/2), M)) << endl;
