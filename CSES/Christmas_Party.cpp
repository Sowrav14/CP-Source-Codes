/**
 * @file Christmas_Party.cpp
 * @author Sowrav Nath (Sowravnath05102002@gmail.com)
 * @version 0.1
 * @date 2024-09-16
 * @copyright Copyright (c) 2024
 * @problem: CSES - Christmas Party
 * @solution: https://en.wikipedia.org/wiki/Derangement#:~:text=External%20links-,Derangement,-26%20languages
 */
#include<bits/stdc++.h>
...
void solve(){
    ...
    v[2] = 1;
    for(int i=3;i<=n;i++){
        v[i] = gun(ad(v[i-1], v[i-2], M), (i - 1), M);
    }
    cout << v[n] << endl;
