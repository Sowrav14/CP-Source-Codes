/**
 * @file Creating_Strings_II.cpp
 * @author Sowrav Nath (Sowravnath05102002@gmail.com)
 * @version 0.1
 * @date 2024-09-16
 * @copyright Copyright (c) 2024
 * @solution: permutation logic. (n!) / (a! * b! * ....)
 * @ref: https://codeforces.com/blog/entry/82103#:~:text=This%20is%20basic%20combinatorics.%20The,.
 */
#include<bits/stdc++.h>
...
void solve(){
    ...
    for(auto c : s) v[c-'a']++;
    for(auto i : v) ans = gun(ans, invf[i], M);
